...
abstract class BaseComment extends BaseObject implements Persistent
{
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = CommentPeer::PRODUCT_ID;
        }
    ...
    public function setRating($v)
    {
        ...
        if ($this->rating !== $v) {
            $this->rating = $v;
            $this->modifiedColumns[] = CommentPeer::RATING;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = CommentPeer::ACTIVE;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CommentPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(CommentPeer::TEXT)) {
            $modifiedColumns[':p' . $index++]  = '`text`';
        }
        if ($this->isColumnModified(CommentPeer::RATING)) {
            $modifiedColumns[':p' . $index++]  = '`rating`';
        }
        if ($this->isColumnModified(CommentPeer::ACTIVE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentPeer::PRODUCT_ID)) $criteria->add(CommentPeer::PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(CommentPeer::TEXT)) $criteria->add(CommentPeer::TEXT, $this->text);
        if ($this->isColumnModified(CommentPeer::RATING)) $criteria->add(CommentPeer::RATING, $this->rating);
        if ($this->isColumnModified(CommentPeer::ACTIVE)) $criteria->add(CommentPeer::ACTIVE, $this->active);
    ...
    public function getProduct(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduct === null && ($this->product_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduct->addComments($this);
             */
        }
