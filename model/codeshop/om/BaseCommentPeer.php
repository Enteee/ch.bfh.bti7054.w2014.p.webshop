...
abstract class BaseCommentPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'ProductId', 'Text', 'Rating', 'Active', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'productId', 'text', 'rating', 'active', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID, CommentPeer::USER_ID, CommentPeer::PRODUCT_ID, CommentPeer::TEXT, CommentPeer::RATING, CommentPeer::ACTIVE, CommentPeer::CREATED_AT, CommentPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'PRODUCT_ID', 'TEXT', 'RATING', 'ACTIVE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'product_id', 'text', 'rating', 'active', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'ProductId' => 2, 'Text' => 3, 'Rating' => 4, 'Active' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'productId' => 2, 'text' => 3, 'rating' => 4, 'active' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (CommentPeer::ID => 0, CommentPeer::USER_ID => 1, CommentPeer::PRODUCT_ID => 2, CommentPeer::TEXT => 3, CommentPeer::RATING => 4, CommentPeer::ACTIVE => 5, CommentPeer::CREATED_AT => 6, CommentPeer::UPDATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'PRODUCT_ID' => 2, 'TEXT' => 3, 'RATING' => 4, 'ACTIVE' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'product_id' => 2, 'text' => 3, 'rating' => 4, 'active' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CommentPeer::PRODUCT_ID);
            $criteria->addSelectColumn(CommentPeer::TEXT);
            $criteria->addSelectColumn(CommentPeer::RATING);
            $criteria->addSelectColumn(CommentPeer::ACTIVE);
    ...
    public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CommentPeer::PRODUCT_ID, ProductPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with their Product objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Comment objects.
    ...
    public static function doSelectJoinProduct(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Comment) to $obj2 (Product)
                $obj2->addComment($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj3 (Product)
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CommentPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Comment) to the collection in $obj2 (Product)
                $obj2->addComment($obj1);
    ...
    /**
     * Selects a collection of Comment objects pre-filled with all related objects except Product.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
