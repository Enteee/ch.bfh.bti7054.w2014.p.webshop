...
abstract class BaseOfferPeer
{
    ...
    /**
     * An identity map to hold any loaded instances of Offer objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ProductId', 'Price', 'Active', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'productId', 'price', 'active', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (OfferPeer::ID, OfferPeer::PRODUCT_ID, OfferPeer::PRICE, OfferPeer::ACTIVE, OfferPeer::CREATED_AT, OfferPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PRODUCT_ID', 'PRICE', 'ACTIVE', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'product_id', 'price', 'active', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProductId' => 1, 'Price' => 2, 'Active' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'productId' => 1, 'price' => 2, 'active' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (OfferPeer::ID => 0, OfferPeer::PRODUCT_ID => 1, OfferPeer::PRICE => 2, OfferPeer::ACTIVE => 3, OfferPeer::CREATED_AT => 4, OfferPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PRODUCT_ID' => 1, 'PRICE' => 2, 'ACTIVE' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'product_id' => 1, 'price' => 2, 'active' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OfferPeer::PRODUCT_ID);
            $criteria->addSelectColumn(OfferPeer::PRICE);
            $criteria->addSelectColumn(OfferPeer::ACTIVE);
            $criteria->addSelectColumn(OfferPeer::CREATED_AT);
            $criteria->addSelectColumn(OfferPeer::UPDATED_AT);
        } else {
    ...
    public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OfferPeer::PRODUCT_ID, ProductPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Offer objects pre-filled with their Product objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProduct(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Offer) to $obj2 (Product)
                $obj2->addOffer($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Offer) to the collection in $obj2 (Product)
                $obj2->addOffer($obj1);
