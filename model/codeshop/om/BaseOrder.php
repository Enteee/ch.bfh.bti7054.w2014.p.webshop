...
abstract class BaseOrder extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the paid_price field.
    ...
    /**
     * Get the [paid_price] column value.
     *
     * @return int
     */
    ...
    public function setOfferId($v)
    {
        ...
        if ($this->offer_id !== $v) {
            $this->offer_id = $v;
            $this->modifiedColumns[] = OrderPeer::OFFER_ID;
        }
    ...
    /**
     * Set the value of [paid_price] column.
     *
     * @param  int $v new value
     * @return Order The current object (for fluent API support)
     */
    public function setPaidPrice($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->paid_price !== $v) {
            $this->paid_price = $v;
            $this->modifiedColumns[] = OrderPeer::PAID_PRICE;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = OrderPeer::ACTIVE;
        }
