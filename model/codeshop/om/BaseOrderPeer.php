...
abstract class BaseOrderPeer
{
    ...
    public static function doCountJoinOffer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::OFFER_ID, OfferPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Order objects pre-filled with their Offer objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Order objects.
    ...
    public static function doSelectJoinOffer(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Order) to $obj2 (Offer)
                $obj2->addOrder($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Order) to the collection in $obj3 (Offer)
                $obj3->addOrder($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = OrderPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Order) to the collection in $obj2 (Offer)
                $obj2->addOrder($obj1);
    ...
    /**
     * Selects a collection of Order objects pre-filled with all related objects except Offer.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
