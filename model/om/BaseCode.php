 ...
 */
abstract class BaseCode extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    /**
     * Initializes internal state of BaseCode object.
     * @see        applyDefaults()
     */
     ...
     * @return Code The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CodePeer::ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = CodePeer::USER_ID;
        }
    ...
    public function setOfferId($v)
    {
        ...
        if ($this->offer_id !== $v) {
            $this->offer_id = $v;
            $this->modifiedColumns[] = CodePeer::OFFER_ID;
        }
    ...
    public function setFilename($v)
    {
        ...
        if ($this->filename !== $v) {
            $this->filename = $v;
            $this->modifiedColumns[] = CodePeer::FILENAME;
        }
    ...
    public function setFilesize($v)
    {
        ...
        if ($this->filesize !== $v) {
            $this->filesize = $v;
            $this->modifiedColumns[] = CodePeer::FILESIZE;
        }
    ...
    public function setMimetype($v)
    {
        ...
        if ($this->mimetype !== $v) {
            $this->mimetype = $v;
            $this->modifiedColumns[] = CodePeer::MIMETYPE;
        }
    ...
    public function setContent($v)
    {
        ...
        $this->modifiedColumns[] = CodePeer::CONTENT;
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = CodePeer::ACTIVE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CodePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CodePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->filesize = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->mimetype = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            if ($row[$startcol + 6] !== null) {
                $this->content = fopen('php://memory', 'r+');
                fwrite($this->content, $row[$startcol + 6]);
                rewind($this->content);
            } else {
                $this->content = null;
            }
            ...
            return $startcol + 10; // 10 = CodePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Code object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CodePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CodePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                CodePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CodePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CodePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Code'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Code'][$this->getPrimaryKey()] = true;
        $keys = CodePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CodePeer::ID)) $criteria->add(CodePeer::ID, $this->id);
        if ($this->isColumnModified(CodePeer::USER_ID)) $criteria->add(CodePeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(CodePeer::OFFER_ID)) $criteria->add(CodePeer::OFFER_ID, $this->offer_id);
        if ($this->isColumnModified(CodePeer::FILENAME)) $criteria->add(CodePeer::FILENAME, $this->filename);
        if ($this->isColumnModified(CodePeer::FILESIZE)) $criteria->add(CodePeer::FILESIZE, $this->filesize);
        if ($this->isColumnModified(CodePeer::MIMETYPE)) $criteria->add(CodePeer::MIMETYPE, $this->mimetype);
        if ($this->isColumnModified(CodePeer::CONTENT)) $criteria->add(CodePeer::CONTENT, $this->content);
        if ($this->isColumnModified(CodePeer::ACTIVE)) $criteria->add(CodePeer::ACTIVE, $this->active);
        if ($this->isColumnModified(CodePeer::CREATED_AT)) $criteria->add(CodePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(CodePeer::UPDATED_AT)) $criteria->add(CodePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(CodePeer::DATABASE_NAME);
        $criteria->add(CodePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Code (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Code Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function getOffer(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aOffer === null && ($this->offer_id !== null) && $doQuery) {
            $this->aOffer = OfferQuery::create()->findPk($this->offer_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aOffer->addCodes($this);
             */
        }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aOffer instanceof Persistent) {
              $this->aOffer->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(CodePeer::DEFAULT_STRING_FORMAT);
    }
