 ...
 * @method CommentQuery orderByProductId($order = Criteria::ASC) Order by the product_id column
 * @method CommentQuery orderByText($order = Criteria::ASC) Order by the text column
 * @method CommentQuery orderByRating($order = Criteria::ASC) Order by the rating column
 ...
 * @method CommentQuery groupByProductId() Group by the product_id column
 * @method CommentQuery groupByText() Group by the text column
 * @method CommentQuery groupByRating() Group by the rating column
 ...
 *
 * @method CommentQuery leftJoinProduct($relationAlias = null) Adds a LEFT JOIN clause to the query using the Product relation
 * @method CommentQuery rightJoinProduct($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Product relation
 * @method CommentQuery innerJoinProduct($relationAlias = null) Adds a INNER JOIN clause to the query using the Product relation
 *
 ...
 * @method Comment findOneByProductId(int $product_id) Return the first Comment filtered by the product_id column
 * @method Comment findOneByText(string $text) Return the first Comment filtered by the text column
 * @method Comment findOneByRating(int $rating) Return the first Comment filtered by the rating column
 ...
 * @method array findByProductId(int $product_id) Return Comment objects filtered by the product_id column
 * @method array findByText(string $text) Return Comment objects filtered by the text column
 * @method array findByRating(int $rating) Return Comment objects filtered by the rating column
...
abstract class BaseCommentQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `user_id`, `product_id`, `text`, `rating`, `active`, `created_at`, `updated_at` FROM `comment` WHERE `id` = :p0';
        try {
    ...
    public function filterByProductId($productId = null, $comparison = null)
    {
        if (is_array($productId)) {
            ...
            if (isset($productId['min'])) {
                $this->addUsingAlias(CommentPeer::PRODUCT_ID, $productId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($productId['max'])) {
                $this->addUsingAlias(CommentPeer::PRODUCT_ID, $productId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CommentPeer::PRODUCT_ID, $productId, $comparison);
    }
    ...
    public function filterByRating($rating = null, $comparison = null)
    {
        if (is_array($rating)) {
            $useMinMax = false;
            if (isset($rating['min'])) {
                $this->addUsingAlias(CommentPeer::RATING, $rating['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($rating['max'])) {
                $this->addUsingAlias(CommentPeer::RATING, $rating['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CommentPeer::RATING, $rating, $comparison);
    }
    ...
    public function filterByProduct($product, $comparison = null)
    {
        if ($product instanceof Product) {
            return $this
                ->addUsingAlias(CommentPeer::PRODUCT_ID, $product->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(CommentPeer::PRODUCT_ID, $product->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
