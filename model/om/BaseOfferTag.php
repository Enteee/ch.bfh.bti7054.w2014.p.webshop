 ...
 */
abstract class BaseOfferTag extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'OfferTagPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = OfferTagPeer::ID;
        }
    ...
    public function setOfferId($v)
    {
        ...
        if ($this->offer_id !== $v) {
            $this->offer_id = $v;
            $this->modifiedColumns[] = OfferTagPeer::OFFER_ID;
        }
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = OfferTagPeer::TAG_ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = OfferTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = OfferTagQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OfferTagPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = OfferTagPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = OfferTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['OfferTag'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OfferTag'][$this->getPrimaryKey()] = true;
        $keys = OfferTagPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(OfferTagPeer::DATABASE_NAME);
        $criteria->add(OfferTagPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of OfferTag (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return OfferTag Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OfferTagPeer::DEFAULT_STRING_FORMAT);
    }
