...
abstract class BaseReviewPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ReviewPeer::ID, ReviewPeer::USER_ID, ReviewPeer::PRODUCT_ID, ReviewPeer::TEXT, ReviewPeer::RATING, ReviewPeer::ACTIVE, ReviewPeer::CREATED_AT, ReviewPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ReviewPeer::ID => 0, ReviewPeer::USER_ID => 1, ReviewPeer::PRODUCT_ID => 2, ReviewPeer::TEXT => 3, ReviewPeer::RATING => 4, ReviewPeer::ACTIVE => 5, ReviewPeer::CREATED_AT => 6, ReviewPeer::UPDATED_AT => 7, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReviewPeer::TEXT);
            $criteria->addSelectColumn(ReviewPeer::RATING);
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ReviewPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ReviewPeer::PRODUCT_ID, ProductPeer::ID, $join_behavior);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ReviewPeer::ID) && $criteria->keyContainsValue(ReviewPeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.ReviewPeer::ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(ReviewPeer::ID);
            if ($value) {
                $selectCriteria->add(ReviewPeer::ID, $value, $comparison);
            } else {
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = ReviewPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
