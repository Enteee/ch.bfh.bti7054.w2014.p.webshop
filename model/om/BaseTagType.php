...
/**
 * Base class that represents a row from the 'cs_tag_type' table.
 *
 *
 *
 * @package    propel.generator.model.om
 */
abstract class BaseTagType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'TagTypePeer';
    ...
    /**
     * Initializes internal state of BaseTagType object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TagTypePeer::ID;
        }
    ...
    public function setActive($v)
    {
        ...
        if ($this->active !== $v) {
            $this->active = $v;
            $this->modifiedColumns[] = TagTypePeer::ACTIVE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = TagTypePeer::CREATED_AT;
            }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TagTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TagTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(TagTypePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(TagTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(TagTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                TagTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO [cs_tag_type] (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TagTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TagTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['TagType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['TagType'][$this->getPrimaryKey()] = true;
    ...
    {
        $criteria = new Criteria(TagTypePeer::DATABASE_NAME);
        $criteria->add(TagTypePeer::ID, $this->id);
     ...
     * @return PropelObjectCollection|Tag[] List of Tag objects
     */
    public function getTagsJoinTagRelatedByParentId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TagQuery::create(null, $criteria);
        $query->joinWith('TagRelatedByParentId', $join_behavior);
    ...
    {
        return (string) $this->exportTo(TagTypePeer::DEFAULT_STRING_FORMAT);
    }
