...
abstract class BaseUser extends BaseObject implements Persistent
{
    ...
    public function setCredits($v)
    {
        ...
        if ($this->credits !== $v) {
            $this->credits = $v;
            $this->modifiedColumns[] = UserPeer::CREDITS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->credits = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPeer::CREDITS)) $criteria->add(UserPeer::CREDITS, $this->credits);
     ...
     * @return PropelObjectCollection|Code[] List of Code objects
     */
    public function getCodesJoinOffer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CodeQuery::create(null, $criteria);
     ...
     * @return PropelObjectCollection|Comment[] List of Comment objects
     */
    public function getCommentsJoinProduct($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CommentQuery::create(null, $criteria);
     ...
     * @return PropelObjectCollection|Order[] List of Order objects
     */
    public function getOrdersJoinOffer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = OrderQuery::create(null, $criteria);
        $query->joinWith('Offer', $join_behavior);
