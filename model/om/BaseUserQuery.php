 ...
 * @method UserQuery orderByCredits($order = Criteria::ASC) Order by the credits column
 ...
 * @method UserQuery groupByCredits() Group by the credits column
 ...
 *
 * @method UserQuery leftJoinCode($relationAlias = null) Adds a LEFT JOIN clause to the query using the Code relation
 * @method UserQuery rightJoinCode($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Code relation
 * @method UserQuery innerJoinCode($relationAlias = null) Adds a INNER JOIN clause to the query using the Code relation
 *
 ...
 *
 * @method UserQuery leftJoinOrder($relationAlias = null) Adds a LEFT JOIN clause to the query using the Order relation
 * @method UserQuery rightJoinOrder($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Order relation
 * @method UserQuery innerJoinOrder($relationAlias = null) Adds a INNER JOIN clause to the query using the Order relation
 *
 ...
 * @method User findOneByCredits(int $credits) Return the first User filtered by the credits column
 ...
 * @method array findByCredits(int $credits) Return User objects filtered by the credits column
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    public function filterByCredits($credits = null, $comparison = null)
    {
        if (is_array($credits)) {
            ...
            if (isset($credits['min'])) {
                $this->addUsingAlias(UserPeer::CREDITS, $credits['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($credits['max'])) {
                $this->addUsingAlias(UserPeer::CREDITS, $credits['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserPeer::CREDITS, $credits, $comparison);
    }
    ...
    public function filterByCode($code, $comparison = null)
    {
        if ($code instanceof Code) {
            return $this
                ->addUsingAlias(UserPeer::ID, $code->getUserId(), $comparison);
    ...
    public function filterByReview($review, $comparison = null)
    {
        if ($review instanceof Review) {
            return $this
                ->addUsingAlias(UserPeer::ID, $review->getUserId(), $comparison);
    ...
    public function filterByOrder($order, $comparison = null)
    {
        if ($order instanceof Order) {
            return $this
                ->addUsingAlias(UserPeer::ID, $order->getUserId(), $comparison);
