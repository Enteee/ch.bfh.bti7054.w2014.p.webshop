...
abstract class BaseProductCategoryPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'ProductId', 'CategoryId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'productId', 'categoryId', ),
        BasePeer::TYPE_COLNAME => array (ProductCategoryPeer::ID, ProductCategoryPeer::PRODUCT_ID, ProductCategoryPeer::CATEGORY_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PRODUCT_ID', 'CATEGORY_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'product_id', 'category_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ProductId' => 1, 'CategoryId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'productId' => 1, 'categoryId' => 2, ),
        BasePeer::TYPE_COLNAME => array (ProductCategoryPeer::ID => 0, ProductCategoryPeer::PRODUCT_ID => 1, ProductCategoryPeer::CATEGORY_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PRODUCT_ID' => 1, 'CATEGORY_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'product_id' => 1, 'category_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
